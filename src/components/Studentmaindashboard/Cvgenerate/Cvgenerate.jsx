...
const Cvgenerate = () => {
  ...
  return (
    <div className="max-w-4xl min-h-screen p-6 mx-auto text-left bg-white">
      {/* Title Section */}
        ...
        <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 flex flex-col items-center justify-center min-h-[400px]">
          ...
          {isGenerating && (
            <div className="w-full space-y-4 animate-pulse">
              ...
              <p className="pt-4 font-medium text-center text-blue-600">Identifying key skills and keywords... [cite: 20, 23]</p>
            </div>
          )}
          ...
          {isCompleted && (
            <div className="w-full text-center animate-fadeIn">
              ...
              <p className="mb-6 text-sm text-gray-600">
                Your CV has been tailored to highlight skills matching this job role. 
              </p>
