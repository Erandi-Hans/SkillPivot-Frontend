...
import Navbar from '../Navbar/Navbar.jsx'; // Importing the shared Navbar

const Manageapplication = () => {
  // Sample data for applications - This will eventually come from your SQL Server database
  ...
  // Logic to define status badge styles based on application status
  ...
  return (
    <div className="min-h-screen bg-[#F3F2EF]">
      ...
      {/* Main Content Wrapper - Centered and Padded for the Navbar */}
      <div className="container max-w-6xl px-4 pt-24 pb-12 mx-auto">
        
        {/* White Card Container for the Application Table */}
        <div className="p-8 bg-white shadow-xl rounded-xl border border-gray-200 min-h-[80vh]">
          
          {/* Page Header with Title and Search/Filter actions */}
          ...
          <div className="overflow-x-auto border border-gray-100 rounded-xl">
                  ...
                  <tr key={app.id} className="transition-colors hover:bg-blue-50/30">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">
                      <div className="flex items-center gap-1">
                        <Clock size={14} className="text-gray-400" /> {app.date}
                      </div>
                    </td>
                    <td className="px-6 py-4">
            ...
            {/* Empty State: Visible if there are no applications in the list */}
            {applications.length === 0 && (
              <div className="py-20 text-center bg-white">
                <p className="font-medium text-gray-400">You haven't applied for any jobs yet.</p>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-between px-2 pt-4 mt-8 text-xs text-gray-500 border-t border-gray-100">
            <p>Showing {applications.length} total applications</p>
